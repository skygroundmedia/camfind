...
static float      const kCFDetailTransitionDuration     = 0.6;
...
static NSString * const kCFProcessorImpctfulSearchingComplete   = @"Impctful Database Search Complete";   // processorStatusImpctfulSearchingComplete
static NSString * const kCFProcessorImpctfulSearchingFailed     = @"Impctful Database Search Failed";     // processorStatusImpctfulSearchingFailed
